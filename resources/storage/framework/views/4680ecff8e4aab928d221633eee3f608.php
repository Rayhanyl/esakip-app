...
<?php endif; ?>
    <section class="section">
        <form class="row g-3" action="<?php echo e(route('admin.perda.sasubkegia.update', $sasubkegium->id)); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('put'); ?>
            <?php echo $__env->make('admin.perda.perencanaan.subkegiatan._partials.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </form>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\esakip-app\resources\views/admin/perda/perencanaan/subkegiatan/edit.blade.php ENDPATH**/ ?>