        ...
        <div class="page-heading">
            ...
            <section class="section mt-2">
                <div class="card shadow rounded-4">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="<?php echo e(route('admin.pemkab.pengukuran.store')); ?>"
...
<?php echo $__env->make('layout.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\esakip-app\resources\views/admin/pemkab/pengukuran/create.blade.php ENDPATH**/ ?>