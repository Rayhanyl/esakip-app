...
<?php endif; ?>
    <section class="section">
        <form class="row g-3" action="<?php echo e(route('admin.perda.sastra.store')); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\esakip-app\resources\views/admin/perda/perencanaan/sastra/create.blade.php ENDPATH**/ ?>