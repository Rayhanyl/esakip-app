...
<?php $component = App\View\Components\Admin\Layout\Header::resolve(['title' => 'Sasaran Sub Kegiatan'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="<?php echo e(route('admin.perda.sasubkegia.create')); ?>" class="btn btn-success">
                    Tambah
                </a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-datatable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $perdaSubKegiaData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sasubkegia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="text-center">
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($sasubkegia->sasaran); ?></td>
                                    <td><?php echo e($sasubkegia->tahun); ?></td>
                                    <td>
...
<?php $component = App\View\Components\Admin\Form\ButtonEdit::resolve(['title' => 'Edit Sasaran Sub Kegiatan','route' => 'admin.perda.sasubkegia.edit','id' => ''.e($sasubkegia->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Admin\Form\ButtonDelete::resolve(['title' => 'Delete Sasaran Sub Kegiatan','route' => 'admin.perda.sasubkegia.destroy','id' => ''.e($sasubkegia->id).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layout.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\esakip-app\resources\views/admin/perda/perencanaan/subkegiatan/index.blade.php ENDPATH**/ ?>