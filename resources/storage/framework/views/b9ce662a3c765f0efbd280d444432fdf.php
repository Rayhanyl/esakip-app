...
<?php $component = App\View\Components\Admin\Form\Select::resolve(['label' => 'Tahun','name' => 'tahun','value' => ''.e($saske->tahun ?? '2024').'','lists' => $tahun_options] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal7b099f880a33b5fbbd5df8fd87ae25ac = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7b099f880a33b5fbbd5df8fd87ae25ac = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\Select::resolve(['label' => 'Sasaran Program','name' => 'perda_prog_id','value' => ''.e($saske->perda_prog_id ?? '').'','lists' => $saspro_options] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\Select::class))->getConstructor()): ?>
...
<?php $component = App\View\Components\Admin\Form\Text::resolve(['label' => 'Sasaran Kegiatan','name' => 'sasaran','value' => ''.e($saske->sasaran ?? '').''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<div id="row-indikator-sasaran">
    <?php $__empty_1 = true; $__currentLoopData = $saske->perda_kegia_ins ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
            $key = Str::random(4);
        ?>
                        ...
                        <div class="col-12 d-flex justify-content-between my-3">
                            ...
                            <?php if($loop->iteration == 1): ?>
                                <button class="btn btn-primary" type="button"
                                    onclick="addComponent('row-indikator-sasaran', '<?php echo e(route('admin.perda.saske.indicator')); ?>')">Tambah</button>
                            <?php else: ?>
...
<?php $component = App\View\Components\Admin\Form\TextArea::resolve(['col' => 'col-12','label' => 'Indikator Kegiatan','name' => 'indikator['.e($key).'][indikator]','value' => ''.e($item->indikator).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\Text::resolve(['label' => 'Kegiatan','name' => 'indikator['.e($key).'][kegiatan]','value' => ''.e($item->kegiatan).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\Text::class))->getConstructor()): ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <?php if (isset($component)) { $__componentOriginalf68a00c9b97ea00ccfbcb83950efb7c6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf68a00c9b97ea00ccfbcb83950efb7c6 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\TextArea::resolve(['col' => 'col-12','label' => 'Indikator Kegiatan','name' => 'indikator['.e($key).'][indikator]'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text-area'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\TextArea::class))->getConstructor()): ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\Text::resolve(['label' => 'Kegiatan','name' => 'indikator['.e($key).'][kegiatan]'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\Text::class))->getConstructor()): ?>
...
<?php /**PATH C:\laragon\www\esakip-app\resources\views/admin/perda/perencanaan/kegiatan/_partials/form.blade.php ENDPATH**/ ?>