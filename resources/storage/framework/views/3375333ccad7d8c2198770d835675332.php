...
<?php $__env->startSection('content-landingpage'); ?>
    ...
    <div class="section sec-services">
        <div class="container">
            <div class="row">
                <form class="row" action="<?php echo e(route('aspu.perencanaan.perda-renstra')); ?>" method="GET">
                                ...
                                <table class="table table-striped table-hover" id="data-table-renstra" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $__currentLoopData = $item->perda_sastra_ins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indikator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $iter++;
                                                ?>
                                                <tr style="font-size:13px">
                                                    ...
                                                    <td class="text-center"><?php echo e($indikator->target1); ?></td>
                                                    <td class="text-center"><?php echo e($indikator->target2); ?></td>
                                                    <td class="text-center"><?php echo e($indikator->target3); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
...
<?php echo $__env->make('layout.akses_publik.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\esakip-app\resources\views/aspu/perencanaan/perda/renstra/index.blade.php ENDPATH**/ ?>