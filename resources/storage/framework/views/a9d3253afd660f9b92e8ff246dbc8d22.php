<div class="card">
    <div class="card-header">
        <h4 class="card-title"><?php echo e($title ?? ''); ?> Sasaran Bupati</h4>
    </div>
    <div class="card-body">
        <div class="row">
...
<?php $component = App\View\Components\Admin\Form\Text::resolve(['label' => 'Sasaran Bupati','name' => 'sasaran','value' => ''.e($sastra->sasaran ?? '').''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<div id="row-indikator-sasaran-bupati">
    <?php if(isset($sastra->pemkab_sastra_ins)): ?>
        <?php $__currentLoopData = $sastra->pemkab_sastra_ins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $key = Str::random(4);
            ?>
            <div class="col-indikator-sasaran-bupati-<?php echo e($key); ?> mt-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12 d-flex justify-content-between my-3">
                                ...
                                <?php if($loop->iteration == 1): ?>
                                    <button class="btn btn-primary" type="button"
                                        onclick="addComponent('row-indikator-sasaran-bupati', '<?php echo e(route('admin.pemkab.sastra.indicator')); ?>')">Tambah</button>
                                <?php else: ?>
                                    <button class="btn btn-danger" type="button"
                                        onclick="removeComponent('col-indikator-sasaran-bupati-<?php echo e($key); ?>')">Hapus</button>
                                <?php endif; ?>
                            </div>
                            <hr>
...
<?php $component = App\View\Components\Admin\Form\TextArea::resolve(['col' => 'col-12','label' => 'Indikator Sasaran Bupati','name' => 'indikator['.e($key).'][indikator]','value' => ''.e($item->indikator).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            <div class="col-12" id="col-penanggung-jawab-<?php echo e($key); ?>">
                                <?php if(isset($item->penanggung_jawabs)): ?>
                                    <?php $__currentLoopData = $item->penanggung_jawabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $key2 = Str::random(4);
                                        ?>
                                                ...
                                                <div>
                                                    <?php if($loop->iteration == 1): ?>
                                                        <button class="btn btn-success" type="button"
                                                            onclick="addSubComponent('col-penanggung-jawab-<?php echo e($key); ?>', '<?php echo e(route('admin.pemkab.sastra.penanggung-jawab')); ?>', '<?php echo e($key); ?>')">
...
<?php endif; ?>
                            ...
                            <div class="col-12" id="col-simple-action-<?php echo e($key); ?>">
                                <?php if(isset($item->simple_actions)): ?>
                                    <?php $__currentLoopData = $item->simple_actions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $key3 = Str::random(4);
                                        ?>
                                        <div class="row row-simple-action-<?php echo e($key3); ?>">
                                            <input type="hidden"
                                                name="indikator[<?php echo e($key); ?>][action][<?php echo e($key3); ?>][id]"
                                                value="<?php echo e($item3->id); ?>">
                                            <?php if (isset($component)) { $__componentOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\Text::resolve(['col' => 'col-11','label' => 'Simple Action','name' => 'indikator['.e($key).'][action]['.e($key3).'][value]','placeholder' => 'Simple Action','value' => ''.e($item3->action).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                                            <div class="col-1">
                                                ...
                                                <div>
                                                    <?php if($loop->iteration == 1): ?>
                                                        <button class="btn btn-success" type="button"
                                                            onclick="addSubComponent('col-simple-action-<?php echo e($key); ?>', '<?php echo e(route('admin.pemkab.sastra.simple-action')); ?>', '<?php echo e($key); ?>')">
                                                            <i class="bi bi-plus"></i>
                                                        </button>
                                                    <?php else: ?>
                                                        <button class="btn btn-danger" type="button"
                                                            onclick="removeComponent('row-simple-action-<?php echo e($key3); ?>')">
                                                            <i class="bi bi-dash"></i>
                                                        </button>
                                                    <?php endif; ?>
                                                </div>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="row row-simple-action-<?php echo e($key3); ?>">
                                        <?php if (isset($component)) { $__componentOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\Text::resolve(['col' => 'col-11','label' => 'Simple Action','name' => 'indikator['.e($key).'][action]['.e($key3).'][value]','placeholder' => 'Simple Action'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\Text::class))->getConstructor()): ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <?php if (isset($component)) { $__componentOriginalf68a00c9b97ea00ccfbcb83950efb7c6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf68a00c9b97ea00ccfbcb83950efb7c6 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\TextArea::resolve(['col' => 'col-12','label' => 'Indikator Sasaran Bupati','name' => 'indikator['.e($key).'][indikator]'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text-area'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\TextArea::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <div class="col-12" id="col-simple-action-<?php echo e($key); ?>">
                            <?php
                                $key2 = Str::random(4);
                            ?>
                            <div class="row row-simple-action-<?php echo e($key2); ?>">
                                <?php if (isset($component)) { $__componentOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaba835d4d7e25596a8dd13dc7fe0b567 = $attributes; } ?>
<?php $component = App\View\Components\Admin\Form\Text::resolve(['col' => 'col-11','label' => 'Simple Action','name' => 'indikator['.e($key).'][action]['.e($key2).'][value]','placeholder' => 'Simple Action'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('admin.form.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Admin\Form\Text::class))->getConstructor()): ?>
...
<?php /**PATH C:\laragon\www\esakip-app\resources\views/admin/pemkab/sastra/_partials/form.blade.php ENDPATH**/ ?>