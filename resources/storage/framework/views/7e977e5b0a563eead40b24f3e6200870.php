...
<?php $__env->startSection('content-landingpage'); ?>
    ...
    <div class="section sec-services">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form class="row g-3" action="<?php echo e(route('aspu.perencanaan.pemkab-perjanjian')); ?>" method="GET">
...
<?php echo $__env->make('layout.akses_publik.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\esakip-app\resources\views/aspu/perencanaan/pemkab/perjanjian/index.blade.php ENDPATH**/ ?>