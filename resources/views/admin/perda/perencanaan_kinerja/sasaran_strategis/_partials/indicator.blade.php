        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 form-group">
                    ...
                    <input type="text" name="indikator_sasaran[{{ $iter ?? 0 }}][indikator_sasaran]"
                ...
                <div class="col-12 row my-3">
                    ...
                    <div class="col-4 form-group">
                        ...
                        <input type="text" name="indikator_sasaran[{{ $iter ?? 0 }}][target1]"
                            class="form-control" aria-describedby="pengampu">
                    </div>
                    <div class="col-4 form-group">
                        <label for="pengampu" class="form-label">2025</label>
                        <input type="text" name="indikator_sasaran[{{ $iter ?? 0 }}][target2]"
                            class="form-control" aria-describedby="pengampu">
                    </div>
                    <div class="col-4 form-group">
                        <label for="pengampu" class="form-label">2026</label>
                        <input type="text" name="indikator_sasaran[{{ $iter ?? 0 }}][target3]"
                            class="form-control" aria-describedby="pengampu">
                    </div>
                </div>
