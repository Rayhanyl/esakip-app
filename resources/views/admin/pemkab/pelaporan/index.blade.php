                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="data-table-pelaporan-kinerja-pemkab"
                                        ...
                                        <tbody>
                                            @foreach ($pemkabPelaporan as $index => $pelaporan)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top"
                                                            ...
                                                            href="{{ route('admin.pemkab.pelaporan.download', ['pelaporan' => $pelaporan->id]) }}">
                                                        ...
                                                        <div class="row  g-0">
                                                            <div class="col-12 col-md-6 col-lg-6">
                                                                <a data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    ...
                                                                    href="{{ route('admin.pemkab.pelaporan.edit', ['pelaporan' => $pelaporan->id]) }}">
                                                            ...
                                                            <div class="col-12 col-md-6 col-lg-6">
                                                                ...
                                                                <form id="delete-form-{{ $pelaporan->id }}"
                                                                    action="{{ route('admin.pemkab.pelaporan.destroy', ['pelaporan' => $pelaporan->id]) }}"
