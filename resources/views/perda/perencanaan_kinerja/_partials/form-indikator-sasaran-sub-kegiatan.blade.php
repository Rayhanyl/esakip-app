            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <input type="text" id="pengampu" class="form-control" aria-describedby="pengampu"
                        name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][indikator_sub_kegiatan]">
                </div>
                <div class="col-12 col-lg-6 form-group">
                ...
                <div class="col-12 col-lg-3 form-group">
                    ...
                    <input type="text" id="pengampu" class="form-control" aria-describedby="pengampu"
                        name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][triwulan1]">
                </div>
                <div class="col-12 col-lg-3 form-group">
                    <label for="pengampu" class="form-label">Triwulan 2</label>
                    <input type="text" id="pengampu" class="form-control" aria-describedby="pengampu"
                        name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][triwulan2]">
                </div>
                <div class="col-12 col-lg-3 form-group">
                    <label for="pengampu" class="form-label">Triwulan 3</label>
                    <input type="text" id="pengampu" class="form-control" aria-describedby="pengampu"
                        name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][triwulan3]">
                </div>
                <div class="col-12 col-lg-3 form-group">
                    <label for="pengampu" class="form-label">Triwulan 4</label>
                    <input type="text" id="pengampu" class="form-control" aria-describedby="pengampu"
                        name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][triwulan4]">
                </div>
                <div class="col-12 col-lg-6 form-group">
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <input type="text" id="pengampu" class="form-control" aria-describedby="pengampu"
                        name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][sub_kegiatan]">
                </div>
                <div class="col-12 col-lg-6 form-group">
