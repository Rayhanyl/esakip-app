        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 form-group">
                    ...
                    <input type="text" name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][indikator_sasaran]"
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    <input type="text" name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][satuan]"
                        class="form-control" aria-describedby="pengampu">
                </div>
                <div class="col-12 col-lg-6 form-group">
                ...
                <div class="col-12 col-lg-12 form-group">
                    ...
                    <fieldset class="form-group">
                        <select class="form-select" id="basicSelect"
                            name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][tipe_perhitungan]">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <input type="text" name="indikator_sasaran_bupati[{{ $iter ?? 0 }}][penanggung_jawab]"
                        id="pengampu" class="form-control" aria-describedby="pengampu">
                </div>
            </div>
        </div>
