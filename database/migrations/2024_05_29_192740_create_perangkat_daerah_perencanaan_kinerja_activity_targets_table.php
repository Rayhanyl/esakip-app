...
return new class extends Migration
{
    ...
    {
        Schema::create('perda_perencanaan_kinerja_activity_targets', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('perangkat_daerah_perencanaan_kinerja_activity_targets');
    }
};
