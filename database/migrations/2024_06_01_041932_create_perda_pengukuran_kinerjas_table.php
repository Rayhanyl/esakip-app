...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('perda_pengukuran_kinerjas', function (Blueprint $table) {
            ...
            $table->foreignId('sasaran_strategis_indikator_id')->onDelete('cascade');
            $table->foreignId('sasaran_sub_kegiatan_id')->onDelete('cascade');
            $table->foreignId('sasaran_sub_kegiatan_indikator_id')->onDelete('cascade');
            ...
            $table->foreignId('anggaran_sub_kegiatan_id')->onDelete('cascade');
            $table->double('anggaran_pagu')->nullable();
            $table->double('anggaran_realisasi')->nullable();
            $table->double('anggaran_capaian')->nullable();
            $table->double('tahunan_sasaran_strategis_id')->onDelete('cascade');
            $table->double('tahunan_sasaran_strategis_indikator_id')->onDelete('cascade');
